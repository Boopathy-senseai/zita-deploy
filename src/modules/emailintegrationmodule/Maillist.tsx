...
const Maillist = ({ messagelist, selectmessage }: Props) => {
  ...
  return (
    <div>
      <Flex style={{ marginLeft: '2px', borderRight:"1px solid #c3c3c3"}} className={styles.maillist}>
        {/* <InputText
        ...
        <Flex row between style={{padding: "4px", marginBottom: "10px", borderBottom: "1px solid #c3c3c3"}}>
          <Text>Inbox</Text>
          <Flex title='Refresh' marginLeft={5}>
            <SvgRefresh width={18} height={18} />
                ...
                <>
                  ...
                  >
                    <Flex row start className={styles.mailCard}>
                      ...
                      >
                        <Flex column start between style={{display: "flex", flexDirection:"column"}}>
                          <Flex row between>
                            <Text
                              size={14}
