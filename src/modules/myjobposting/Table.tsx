                  ...
                  <>
                    <tr style={{height:50}}>
                      ...
                      {list.jd_status__label_name === "Inactive" ? (
                        ...
                        >
                          {isEmpty(list.zita_match) ? <Text className={styles.zeroorder}  >0</Text> : <Text className={styles.numberorder} >{list.zita_match}</Text>}
                        </td>
                      ) : (
                        <td
                          style={{
                        ...
                        >
                           {isEmpty(list.zita_match) ? <Text className={styles.zeroorder}>0</Text> :
                        ...
                        >
                          {isEmpty(list.invite_to_apply)
                            ...
                            :<Text className={styles.numberorder} >{list.invite_to_apply}</Text> }
                        </td>
                      ) : (
                        <td
                          style={{
