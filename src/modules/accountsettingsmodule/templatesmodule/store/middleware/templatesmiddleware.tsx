...
import { ADD_PIPELINE_STAGE, DELETE_PIPELINE_STAGE, UPDATE_PIPELINE_STAGE,
     PIPELINE_STAGES, PIPELINE_STAGES_REORDER, PIPELINE_SUGGESTIONS, UPDATE_COLOUR_PALLATE } from '../../../../../actions/actions';
...
export const jobPipelineStagesMiddleWare = createAsyncThunk<
    StageData[],
    void
>(
    PIPELINE_STAGES,
...
export const updateColourMiddleWare = createAsyncThunk<
String,
String
>(
