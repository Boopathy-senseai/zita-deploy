...
const LinkShare = (props) => {
  ...
  const {share,title,type,duration,setShare,sharelinkdata,response,details,sharedata} = props;
  ...
  return (
    ...
    <div className={styles.sharelink}>
        ...
        {/* <Flex column>
          <Text className={styles.title}>{details.event_name}</Text>
          <Text className={styles.type}>{details.event_type}</Text>
        </Flex> */}
        {/* </div>
        <div> */}
  ...
  <div className={styles.rightColumn}>
    <Flex column>
      ...
      <Flex row>
        <Text size={16}>Select to whom you want to share the link</Text>
      </Flex>
        ...
        <div className={styles.grid}>
          {data.map((name, index) => (
            <Flex row key={index}>
              ...
              <Text size={14}>{name.full_name}({name.type})</Text></div>
            </Flex>
          ))}
          </div>
        </Flex>
