...
const SvgCalendarEvent = ({ width, height, fill }: typeof defaultProps) => (
    <svg
    ...
    >
      ...
      0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1
       1h12a1 1 0 0 0 1-1V4H1z" />
    </svg>
  );
  SvgCalendarEvent.defaultProps = defaultProps;
